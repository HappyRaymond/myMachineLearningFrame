...
if __name__ == '__main__':
    X_train, X_test, Y_train, Y_test = myTrain_test_split("../dataset/BayesianRidge_economics_finished_新界-離島.csv", splitYear=2019)
    ...
    X_train, X_test, Y_train, Y_test = myTrain_test_split_Estate("../dataset/BayesianRidge_economics_finished_新界-離島.csv")
    Y_train, Y_test = Y_train.reshape(-1), Y_test.reshape(-1)
    print(X_train.shape, X_test.shape, Y_train.shape, Y_test.shape)
