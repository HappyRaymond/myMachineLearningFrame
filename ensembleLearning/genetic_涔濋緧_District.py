...
if __name__ == '__main__':
    X_train, X_test, Y_train, Y_test = myTrain_test_split_Estate("../dataset/BayesianRidge_economics_finished_九龍.csv")


    # X_train, X_test, Y_train, Y_test = myTrain_test_split("../dataset/BayesianRidge_economics_finished_九龍.csv", splitYear=2018)
